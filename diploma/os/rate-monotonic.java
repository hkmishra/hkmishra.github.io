...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ReadyQueue ReadyQueue = new Main().new ReadyQueue();
        try {
            ...
            for (int i = 0; i < totalTask; i++) {
                ...
                Task tempTask = new Main().new Task(period, cTime, i);
            ...
            for (int i = 0; ; i++) {
                ...
                for (Task individualTask : PeriodicTaskList) {
                    if (i % individualTask.p == 0) {
                        ReadyQueue.addNewTask(new Main().new Task(individualTask.p, individualTask.c, individualTask.id));
                    }
                }
